"""Revenue Intelligence Agent — factory + auto-registration."""
...
def create_agent() -> Agent:
    ...
    return Agent(
        name=os.environ.get("AGENT_NAME", config.get("name", "revenue_intelligence_agent")) or "revenue_intelligence_agent",
