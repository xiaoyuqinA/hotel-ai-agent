"""Review Decision Agent — factory + auto-registration."""
...
def create_agent() -> Agent:
    """Create and return a Review Decision Agent instance."""
    ...
    return Agent(
        name=os.environ.get("AGENT_NAME", config.get("name", "review_decision_agent")) or "review_decision_agent",
